module.exports = {
    ...
    update: function (conn,data, id_user, callback){
        conn.query(
            "UPDATE users SET name_user = '"+data.name_user+"',lastname_user = '"+data.lastname_user+"',email_user = '"+data.email_user+"',password_user = '"+data.password_user+"', rol = '"+data.rol+"' WHERE id_user = "+id_user+" ",        
            callback
        );
    },
